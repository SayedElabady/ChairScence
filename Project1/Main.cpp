...
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	...
	// render loop
	// -----------
	unsigned char *dataSet[4];
	dataSet[0] = stbi_load("1.jpg", &width, &height, &nrChannels, 0);
	dataSet[1] = stbi_load("2.jpg", &width, &height, &nrChannels, 0);
	dataSet[2] = stbi_load("3.jpg", &width, &height, &nrChannels, 0);
	dataSet[3] = stbi_load("4.jpg", &width, &height, &nrChannels, 0);
	unsigned char *data;
